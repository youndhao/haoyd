...
$.ajax({type:opts.method,cache: false,url:opts.url,data:_1c9,dataType:"json",success:function(data){
_1ca(data);
},error:function(){
...
$.ajax({type:opts.method,cache: false,url:opts.href,cache:false,data:_267,dataType:"html",success:function(data){
_268(data);
},error:function(){
...
var data={};
data[_4a6[1]]=_4a5;
var _4a7=$.ajax({url:_4a6[0],cache: false,dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _4a7=="true";
...
$.ajax({url:data,cache: false,data:_510,dataType:"json",success:function(data){
_511(data);
},error:function(){
...
$.ajax({type:opts.method,cache: false,url:opts.url,data:_7c5,dataType:"json",success:function(data){
_7c6(data);
},error:function(){
...
$.ajax({type:opts.method,cache: false,url:opts.url,data:_913,dataType:"json",success:function(data){
_914(data);
},error:function(){
...
$.ajax({type:opts.method,cache: false,url:opts.url,data:_9c9,dataType:"json",success:function(data){
_9ca(data);
},error:function(){
